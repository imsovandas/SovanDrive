// SovanDrive
//Developed by Sovan Das
//Powered by Das InfoSec
...
const authConfig = {
  "siteName": "SovanDrive", // Website name
  ...
  "roots": // Disk"s Address 
  [
    {
      "id": "1xh7X3l7iVzS7vCZ_DqrbuMJ-aCDdcLqq",
      "name": "All Movies",
      "protect_file_link": false
    },
    {
      "id": "1WWRm3KPQLZn-pYPErIx9nONcvxCOdogu",
      "name": "All Web Series",
      "protect_file_link": false
    },
    {
      "id": "17RycLoO5r_Z6iueDxIbeFtUuI9gqqhiD",
      "name": "All Shows",
      "protect_file_link": false
    },
    {
      "id": "11TPJdsHJOPvjkklYjgWHVOBX7qkKhAVW",
      "name": "All Courses",
      "protect_file_link": false
    },
  ]
...
const uiConfig = 
{
  "theme": "vapor", // Modern, smooth theme
  ...
  "logo_link_name": "𝕊𝕠𝕧𝕒𝕟𝔻𝕣𝕚𝕧𝕖",
  "login_image": "https://i.imgur.com/XGPGgAG.png", // Login page logo image
  ...
  "nav_link_4": "About Me", // change navigation link name
  "nav_link_5": "Marvel", // change navigation link name
  "nav_link_6": "DC", // change navigation link name
  "nav_link_8": "IMAX", // change navigation link name
  "nav_link_7": "All Movie Series", // change navigation link name
  "nav_link_9": "Recently Added", // change navigation link name
  "fixed_footer": true, // If you want the footer to be flexible or fixed.
  "hide_footer": true, // hides the footer from site entirely.
  "header_style_class": "navbar-dark bg-dark", // Modern dark navbar
  "footer_style_class": "bg-dark", // Modern dark footer
  "css_a_tag_color": "#00ffff", // Modern cyan for links
  "css_p_tag_color": "#e0e0e0", // Light grey for better readability
  "folder_text_color": "#00ffff", // Cyan for folder text
  "loading_spinner_class": "text-info", // https://getbootstrap.com/docs/5.0/components/spinners/#colors
  ...
  "contact_link": "https://www.linkedin.com/in/imsovandas/",
  "latest_link": "https://sovandrive.dasinfosec.workers.dev/0:search?q=%F0%9F%86%95",
  "Telegram_link": "https://telegram.dog/sovandas",
  "Marvel_link": "https://sovandrive.dasinfosec.workers.dev/0:/English/Flim%20Franchises/Marvel%20-%20Series%20/",  
  "DC_link": "https://sovandrive.dasinfosec.workers.dev/0:/English/Flim%20Franchises/DC%20-%20Series%20/",
  "Movie_link": "https://sovandrive.dasinfosec.workers.dev/0:/English/Flim%20Franchises/",
  "IMAX_link": "https://sovandrive.dasinfosec.workers.dev/0:search?q=IMAX",
  "copyright_year": "2025", // year of copyright, can be anything like 2015 - 2020 or just 2020
  "company_name": "Das InfoSec", // Name next to copyright
  "company_link": "https://telegram.dog/sovandas", // link of copyright name
  "credit": false, // Set this to true to give us credit
  "display_size": true, // Set this to false to hide display file size
  "display_time": false, // Set this to false to hide display modified time for folder and files
  "display_download": true, // Set this to false to hide download icon for folder and files on main index
  "disable_player": false, // Set this to false to enable audio and video players
  "disable_video_download": false, // Set this to false to enable download buttons for videos
  ...
  "unauthorized_owner_link": "https://telegram.dog/sovandas", // Unauthorized Error Page Link to Owner
  "unauthorized_owner_email": "imsovandas@gmail.com", // Unauthorized Error Page Owner Email
...
const player_config = 
{
  "player": "plyr", // Using Plyr for better performance and features
...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/plyr@${player_config.plyr_io_version}/dist/plyr.min.js"></script>
  <link href="https://cdn.jsdelivr.net/npm/plyr@${player_config.plyr_io_version}/dist/plyr.css" rel="stylesheet">
  <style>
    ...
    .plyr {
      ...
      --plyr-video-controls-padding: 20px;
      --plyr-range-track-height: 4px;
      --plyr-range-thumb-height: 12px;
      --plyr-range-thumb-background: #00ffff;
      --plyr-range-fill-background: #00ffff;
      --plyr-control-icon-size: 18px;
      --plyr-control-spacing: 10px;
      --plyr-control-radius: 4px;
      --plyr-video-controls-background: linear-gradient(rgba(0,0,0,0), rgba(0,0,0,0.8));
...
<html>
   ...
   <body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
           <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="" target="_blank">${uiConfig.nav_link_1}</a>
              </li>
               <li class="nav-item">
                  <a class="nav-link" href="${uiConfig.contact_link}" target="_blank">${uiConfig.nav_link_4}</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="${uiConfig.Marvel_link}" target="_blank">${uiConfig.nav_link_5}</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="${uiConfig.DC_link}" target="_blank">${uiConfig.nav_link_6}</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="${uiConfig.IMAX_link}" target="_blank">${uiConfig.nav_link_8}</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="${uiConfig.Movie_link}" target="_blank">${uiConfig.nav_link_7}</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="${uiConfig.latest_link}" target="_blank">${uiConfig.nav_link_9}</a>
               </li>
    ...
    <div>
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
          ...
          <div class="modal-footer" id="modal-body-space-buttons">
            <a href="#" class="btn-download" id="download-link" download>
     ...
     <br>
     <footer class="footer mt-auto py-3 text-muted ${uiConfig.footer_style_class}" style="left: 0; bottom: 0; width: 100%; color: white; z-index: 9999; display: block;"> <div class="container" style="width: auto; padding: 0 10px;"> <p class="float-end"> <a href="#">Back to top</a> </p> <p>Developed by Sovan Das</p> </div> </footer>
    </div>
   </body>
    ...
    <div class="container-fluid">
     <div class="row no-gutter">
      ...
      <div class="col-md-6 bg-light">
         <div class="logind-flex align-items-center py-5">
          <div class="container">
           <div class="row">
            <div class="col-lg-10 col-xl-7 mx-auto">
              <img src="${uiConfig.login_image}" class="img-fluid" style="width: 250px; display: block; margin-left: auto; margin-right: auto; margin-bottom: 20px;">
