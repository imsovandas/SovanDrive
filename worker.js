...
const authConfig = {
  "siteName": "SovanDrive by Das InfoSec", // Website name
  ...
  [
    {
      "id": "1nWSr36O7Ge7RPANynrA8LRhCwSERRufE",
      "name": "All Movies",
...
const uiConfig = 
{
  ...
  "logo_link_name": "𝕊𝕠𝕧𝕒𝕟𝔻𝕣𝕚𝕧𝕖 by Das InfoSec",
  ...
  // header Options
  "nav_link_1": "Contact Me", // change navigation link name
  ...
  "Marvel_link": "https://sovandrive.dasinfosec.workers.dev/0:/English/Flim%20Franchises/Marvel%20-%20Series/",  
  "DC_link": "https://sovandrive.dasinfosec.workers.dev/0:/English/Flim%20Franchises/DC%20-%20Series%20/",
  "Movie_link": "https://sovandrive.dasinfosec.workers.dev/0:search?q=series",
  ...
  "company_name": "- SovanDrive by Das InfoSec", // Name next to copyright
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
           <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
               ...
               <li class="nav-item">
                  <a class="nav-link" href="${uiConfig.Telegram_link}" target="_blank">${uiConfig.nav_link_1}</a>
               </li>
               <li class="nav-item">
